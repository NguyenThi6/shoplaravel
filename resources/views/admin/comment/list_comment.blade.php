          ...
          <tr>
            ...
            <td>
               ...
               @if( $comm->comment_status ==1)
                        <input type="button"data-comment_status="0" data-comment_id="{{$comm->comment_id}}" id="{{$comm->comment_product_id}}"class="btn btn-primary comment_duyet_btn" value="Duyệt bình luận">
               @else 
                        <input type="button" data-comment_status="1" data-comment_id="{{$comm->comment_id}}" 
                        id="{{$comm->comment_product_id}}" class="btn btn-danger comment_duyet_btn" value="Bỏ duyệt ">
               @endif
            ...
            data-comment_id="{{$comm->comment_id}}">Trả lời</button><br>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có  muốn xóa bình luận này ko?')" href="" class="active styling-edit" ui-toggle-class="">
