...
@section('content')
    ...
    @php
        $product_price = floatval($cart['product_price']);
        $product_qty = intval($cart['product_qty']);
    ...
    <tr>
        ...
        <td class="cart_quantity">
            <div class="cart_quantity_button">
                <input class="cart_quantity" type="number" min="1" name="cart_qty[{{ $cart['session_id'] }}]" value="{{ $product_qty }}" />
            </div>
        </td>
        <td class="cart_total">
